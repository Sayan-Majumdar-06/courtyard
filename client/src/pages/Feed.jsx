...
const Feed = () => {
  ...
  return (
    <div className='bg-[#ebe6de] min-h-screen text-[#2d2a26]'>
      <div className='flex md:max-w-[800px] xl:max-w-[1200px] mx-auto justify-between px-2 min-[450px]:px-4 gap-[0.5rem] min-[450px]:gap-[1rem] sm:gap-[2rem]'>

        {/* Left sidebar */}
        <aside className='sticky top-0 md:w-64 shrink-0 pt-4 min-[450px]:pt-8'>
        ...
        <div className='flex-1 xl:max-w-[600px] py-4 min-[450px]:py-8 space-y-6'>
          {/* Create post trigger */}
          <div className='sticky top-4 backdrop-blur-md bg-white/60 px-4 py-2 rounded-3xl z-20 shadow-sm border border-white/20'>
